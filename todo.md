...
- `[ ]` **Get a bivy or a waterproof bag cover (200–350 g)** if you are sleeping without a tent. Temperature is not the issue — a 45 °F bag has 5–9 °F of margin against the forecast lows (Limekiln 54/53/51/50 °F). **Fog is the issue:** Limekiln is forecast "Areas of fog" every night 9pm–5am with 0–3 mph wind — dead calm plus fog is worst-case condensation — and it sits in a redwood canyon where canopy drip is worse. Check whether your bag's 45 °F is the *comfort* or the *limit* rating; if it's the limit, comfort is ~55 °F and Limekiln's 50–51 °F nights would be cold.
- `[ ]` **If sleeping out, prefer the Big Sur valley to the coast.** Pfeiffer Big Sur is forecast **mostly clear at 56–62 °F** while Limekiln is **fogged in at 50–54 °F** — the valley is inland of the marine layer, so warmer *and* drier (`pch_day1_alt_pfeiffer.gpx`).
