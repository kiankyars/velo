...
|------|------|---------:|----------------------|
| 🇺🇸 **Southbound Highway 1 — San Francisco → Los Angeles** | **leaving 5–6 Aug 2026** | **858.6 km / 3 days** | ⭐ **[BIG-SUR-GPX.md](./BIG-SUR-GPX.md)** |
| 🇪🇺 The Frankfurt Loop | 21 Jun – 12 Jul 2026 | 4,172.7 km / ~22 days | [ROUTE-GPX.md](./ROUTE-GPX.md) |

## 🇺🇸 The immediate one: SF → Big Sur → LA, camping

Three riding days down the coast, camping at the **Limekiln** and **Refugio**
hike/bike sites. Built, audited and validated — GPX in [`gpx/pch_*.gpx`](./gpx),
full write-up in **[BIG-SUR-GPX.md](./BIG-SUR-GPX.md)**.

| Day | From → To | Distance | Climb |
|---|---|---:|---:|
| 1 | 426 Fell St, SF → **Limekiln SP** | **326.4 km** | +3,642 m |
| 2 | Limekiln SP → **Refugio SB** | **302.7 km** | +2,377 m |
| 3 | Refugio SB → **LA Union Station** | **229.5 km** | +781 m |

**Four things building it changed:**

1. **Day 1 measures 326 km, not 280–290 km** — the estimate was ~40 km light,
   which is 1½–2 extra hours, arriving on the Big Sur cliffs in the dark.
2. **Limekiln is reservation-only** — State Parks says outright *"There are no
   first-come, first-served campsites."* Book it (**800-444-7275**) or ride to a
   fallback. Hike/bike is **$5**, check-in 14:00.
3. **Highway 1 is open** (reopened 14 Jan 2026) but there's a **one-way signal
   control at Rocky Creek Bridge, 24/7 through 31 Aug**, up to 15 min — at km 284
   of day 1.
4. **Devil's Slide Trail may be gated** before 08:00 and the tunnels ban bikes,
   so there's now an **inland bypass that costs 0.2 km**
   ([`pch_day1_alt_inland_bypass.gpx`](./gpx/pch_day1_alt_inland_bypass.gpx)).

Every alternative overnight (Pfeiffer, Lucia, Ragged Point, San Simeon, Gaviota,
El Capitán) is a complete loadable stage file, not a note to improvise from.
...
| File | What it covers |
|------|----------------|
| **[BIG-SUR-GPX.md](./BIG-SUR-GPX.md)** | ⭐ **The SF → LA coast route.** Three riding days (858.6 km), the two camping nights, all eight alternative-endpoint files, the road-bike routing profile and why the stock one fails on this coast, the full legality/surface audit, the detected climbs, and the four corrections building it forced on the plan. |
